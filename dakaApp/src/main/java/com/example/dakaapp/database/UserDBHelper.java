...
public class UserDBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "dakaApp.db";
    private static final String TABLE_NAME = "user_info";
    private static final String DAKA_TABLE = "daka_info";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
//        sql =  "CREATE TABLE IF NOT EXISTS " + DAKA_TABLE + " (" +
//                " id VARCHAR PRIMARY KEY AUTOINCREMENT NOT NULL," +
